...
public class LightEventHandlerTest {
    ...
    public void testLightOn() {
        String testLightID = "L8";
        SensorEvent setL8On = new SensorEvent(SensorEventType.LIGHT_ON, testLightID);
        Room corridor = new Room(Arrays.asList(new Light("L0", false), new Light("L1", false)),
                Arrays.asList(new Door(false, "D0"), new Door(false, "D1"), new Door(false, "D2"), new Door(false, "D3")),
                "Corridor");
        Room restroom = new Room(Arrays.asList(new Light("L8", true), new Light("L9", false)),
                Arrays.asList(new Door(false, "D1"), new Door(false, "D5")),
                "Restroom");
        Room restroomBalcony = new Room(Collections.singletonList(new Light("L10", false)),
                Collections.singletonList(new Door(false, "D4")),
        ...
        SmartHome expected = new SmartHome(Arrays.asList(
                corridor, restroom, restroomBalcony, kitchenBalcony, kitchen, childrenRoom));
        new LightEventHandler().handleEvent(smartHome, setL8On);
        Assert.assertEquals(smartHome, expected);
    }
    @Test
    public void testLightOff() {
        String testLightID = "L2";
        SensorEvent setL2Off = new SensorEvent(SensorEventType.LIGHT_OFF, testLightID);
        Room corridor = new Room(Arrays.asList(new Light("L0", false), new Light("L1", false)),
                Arrays.asList(new Door(false, "D0"), new Door(false, "D1"), new Door(false, "D2"), new Door(false, "D3")),
                "Corridor");
        Room restroom = new Room(Arrays.asList(new Light("L8", false), new Light("L9", false)),
        ...
        SmartHome expected = new SmartHome(Arrays.asList(
                corridor, restroom, restroomBalcony, kitchenBalcony, kitchen, childrenRoom));
        new LightEventHandler().handleEvent(smartHome, setL2Off);
        Assert.assertEquals(smartHome, expected);
    }

    @Test
    public void testNullLightOn () {
        String testLightID = "DAMN_LIGHT";
        SensorEvent setDamnLightOn = new SensorEvent(SensorEventType.LIGHT_ON, testLightID);
        Room corridor = new Room(Arrays.asList(new Light("L0", false), new Light("L1", false)),
                Arrays.asList(new Door(false, "D0"), new Door(false, "D1"), new Door(false, "D2"), new Door(false, "D3")),
                "Corridor");
        Room restroom = new Room(Arrays.asList(new Light("L8", false), new Light("L9", false)),
        ...
        SmartHome expected = new SmartHome(Arrays.asList(
                corridor, restroom, restroomBalcony, kitchenBalcony, kitchen, childrenRoom));
        new LightEventHandler().handleEvent(smartHome, setDamnLightOn);
        Assert.assertEquals(smartHome, expected);
    }
}